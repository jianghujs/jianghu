...
; (function (factory) {
    ...
    editormd.markdownToHTML = function (id, options) { // Markdown 渲染为 HTML
        var defaults = { // 默认属性
            ...
            previewCodeHighlight: true,
            plugin_path: `/${window.appInfo.appId}/public/editor.md/lib/`
        };
    ...
    editormd.katexURL = {
        css: `/${window.appInfo.appId}/public/editor.md/lib/katex/katex.min`,
        js: `/${window.appInfo.appId}/public/editor.md/lib/katex/katex.min`,
    };
