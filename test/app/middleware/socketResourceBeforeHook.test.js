...
const socketResourceBeforeHook = require('../../../plugins/socket-io/app/middleware/socketResourceBeforeHook');

describe('test/app/middleware/socketResourceBeforeHook.test.js', () => {
  before(() => {
  ...
  describe('Test middleware socketResourceBeforeHook', () => {
    beforeEach(() => {
      ...
      // this.socketResourceBeforeHook = socketResourceBeforeHook();
    ...
    it('should success', async () => {
      ...
      const result = await socketResourceBeforeHook(this.ctx);
