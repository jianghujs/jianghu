...
const httpResourceHook = require('../../../app/middleware/httpResourceHook');

describe('test/app/middleware/httpResourceHook.test.js', () => {
  before(() => {
  ...
  describe('Test middleware httpResourceHook', () => {
    beforeEach(() => {
      ...
      this.httpResourceHook = httpResourceHook();
    ...
    it('should success', async () => {
      ...
      await this.httpResourceHook(this.ctx, this.nextSpy);
